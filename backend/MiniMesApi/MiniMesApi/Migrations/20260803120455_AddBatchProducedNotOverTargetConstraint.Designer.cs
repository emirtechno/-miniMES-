...
namespace MiniMesApi.Migrations
{
    ...
    [Migration("20260803120455_AddBatchProducedNotOverTargetConstraint")]
    partial class AddBatchProducedNotOverTargetConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MiniMesApi.Models.Batch", b =>
                {
                    ...
                    b.ToTable("Batches", t =>
                        {
                            t.HasCheckConstraint("CK_Batches_ProducedNotOverTarget", "[ProducedQuantity] <= [TargetQuantity]");
