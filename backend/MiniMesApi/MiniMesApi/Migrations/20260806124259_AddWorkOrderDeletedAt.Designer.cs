...
namespace MiniMesApi.Migrations
{
    ...
    [Migration("20260806124259_AddWorkOrderDeletedAt")]
    partial class AddWorkOrderDeletedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniMesApi.Models.StationRuntime", b =>
                {
                    b.Property<string>("StationId")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
                    ...
                    b.ToTable("WorkOrders", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_WorkOrders_Status", "[Status] IN (N'Bekliyor', N'Devam Ediyor', N'Tamamlandı', N'Arşivlendi')");
                        });
                });
