...
namespace MiniMesApi.Migrations
{
    [DbContext(typeof(MesDbContext))]
        partial class MesDbContextModelSnapshot
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Batches", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Batches_Status", "[Status] IN (N'Bekliyor', N'Ýþlemde', N'Tamamlandý')");
                    ...
                    b.ToTable("WorkOrders", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_WorkOrders_Status", "[Status] IN (N'Bekliyor', N'Devam Ediyor', N'Tamamlandý')");
                        });
                });
